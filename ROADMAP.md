...
- [x] **Day 02** — Clients list page at `/clients`: server component reading the data layer, rendering a table of name, company, default rate, and created date. Include an empty state.
