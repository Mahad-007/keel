...
- [ ] **Day 003** — New client form at `/clients/new` backed by a server action: field-level validation, `parseCents` for the rate, inline error rendering, redirect on success, and tests for every validation branch.
